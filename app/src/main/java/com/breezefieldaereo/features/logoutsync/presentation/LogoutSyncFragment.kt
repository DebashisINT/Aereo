package com.breezefieldaereo.features.logoutsync.presentation
...
import com.breezefieldaereo.CustomConstants


import com.breezefieldaereo.R
import com.breezefieldaereo.app.AppDatabase
...
import com.breezefieldaereo.app.utils.Toaster
import com.breezefieldaereo.base.BaseResponse
import com.breezefieldaereo.base.presentation.BaseActivity
import com.breezefieldaereo.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldaereo.features.billing.api.AddBillingRepoProvider
import com.breezefieldaereo.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldaereo.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldaereo.features.document.model.AddEditDocumentInputParams
import com.breezefieldaereo.features.document.model.DocumentAttachmentModel
...
import com.breezefieldaereo.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldaereo.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldaereo.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldaereo.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldaereo.features.orderhistory.model.*
...
import com.breezefieldaereo.features.quotation.model.AddQuotInputModel
import com.breezefieldaereo.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldaereo.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldaereo.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldaereo.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldaereo.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldaereo.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldaereo.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldaereo.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldaereo.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldaereo.mappackage.SendBrod
import com.breezefieldaereo.widgets.AppCustomTextView
import com.breezefieldaereo.MonitorService
import com.breezefieldaereo.MySingleton
import com.breezefieldaereo.app.AlarmReceiver
...
import com.breezefieldaereo.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldaereo.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldaereo.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldaereo.features.orderITC.SyncDeleteOpptL
import com.breezefieldaereo.features.orderITC.SyncEditOppt
import com.breezefieldaereo.features.orderITC.SyncOppt
import com.breezefieldaereo.features.orderITC.SyncOpptProductL
import com.breezefieldaereo.features.orderITC.SyncOrd
import com.breezefieldaereo.features.orderITC.SyncOrdProductL
import com.breezefieldaereo.features.performance.model.Gps_status_list
import com.breezefieldaereo.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldaereo.features.returnsOrder.ReturnProductList
import com.breezefieldaereo.features.returnsOrder.ReturnRequest
import com.breezefieldaereo.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldaereo.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldaereo/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldaereologsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldaereologsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldaereologsample/log.zip").path);
