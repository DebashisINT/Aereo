package com.breezefieldaereo.features.commondialogsinglebtn
...
import com.breezefieldaereo.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldaereo.app.domain.VisitRemarksEntity
...
import com.breezefieldaereo.features.addshop.presentation.ProspectListDialog
import com.breezefieldaereo.features.dashboard.presentation.DashboardActivity
import com.breezefieldaereo.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldaereo.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldaereo/files", "recorded_audio${System.currentTimeMillis()}.mp3")
