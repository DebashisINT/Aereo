...
import com.breezefieldaereo.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldaereo.app.utils.FTStorageUtils
import com.breezefieldaereo.app.utils.NotificationUtils
...
import com.breezefieldaereo.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldaereo.features.addshop.model.QuestionSubmit
import com.breezefieldaereo.features.addshop.model.UpdateAddrReq
import com.breezefieldaereo.features.addshop.model.UpdateAddressShop
...
import com.breezefieldaereo.features.addshop.presentation.*
...
import com.breezefieldaereo.features.location.model.ShopDurationRequestData
...
import com.breezefieldaereo.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldaereo.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldaereo.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldaereo.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldaereo.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldaereoApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
